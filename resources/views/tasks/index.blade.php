            ...
            <div class="kt-card mb-6" id="calendar-section">
                ...
                <div class="kt-card-body">
                    ...
                    <div id="month-view-container">
                        <div class="flex">
                            <!-- Week numbers column -->
                            <div class="flex flex-col w-12 mr-2">
                                <div class="p-2 h-8 text-center text-sm font-medium text-gray-600 dark:text-gray-400" style="margin-bottom: .74rem;">Tyd.</div>
                                <div id="week-numbers" class="flex flex-col gap-1">
                                    <!-- Week numbers will be generated by JavaScript -->
                                </div>
                            </div>
                            <!-- Calendar days -->
                            <div class="flex-1">
    ...
    <script>
        ...
        function renderMonthView() {
            ...
            for (let row = 0; row < rows; row++) {
                ...
                weekCell.className = 'h-32 flex items-center justify-center text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700';
                weekCell.textContent = weekNum;
                weekNumbers.appendChild(weekCell);
