                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="team" class="block mt-1 w-full" type="text" name="team" :value="old('team')" placeholder="np. Jan Kowalski, Anna Nowak" />
