            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('tasks.update', $task) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            @php
                                $selectedTaskTypeIds = old('task_type_ids', $task->taskTypes->pluck('id')->toArray());
                            @endphp
                                    ...
                                    @foreach($taskTypes as $taskType)
                                        <label class="flex items-center space-x-3 py-1.5 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded px-2">
                                            <input type="checkbox"
                                                   name="task_type_ids[]"
                                                   value="{{ $taskType->id }}"
                                                   {{ in_array($taskType->id, $selectedTaskTypeIds) ? 'checked' : '' }}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input id="lokalizacja"
                                       type="text"
                                       name="lokalizacja"
                                       value="{{ old('lokalizacja', $task->lokalizacja) }}"
                            ...
                            <div>
                                ...
                                <input id="nr_lini"
                                       type="text"
                                       name="nr_lini"
                                       value="{{ old('nr_lini', $task->nr_lini) }}"
